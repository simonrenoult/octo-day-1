...
const data = [
  {id: 1, name: 'A great mug', size: 'tall', tags: ['casual', 'cheap'], foo: true},
  {id: 2, name: 'A not so great mug', size: 'samll', tags: ['casual', 'expensive'], foo: false},
  {id: 3, name: 'A deutsch qualidad mug', size: 'medium', tags: ['casual', 'cheap'], foo: false}
]
